...
namespace YK.Common.Proxy.GenerateClass.YK_Models_Systems_SysModules
{
    /// <summary>
    /// 生成代码类
    /// </summary>
    public class SysModules:YK.Models.Systems.SysModules
    {
...
{
get { if (ChanageProperty.ContainsKey("ParentID") == false) { return default(Int32); } else { return (Int32)ChanageProperty["ParentID"]; } } 
set { ChanageProperty.Add("ParentID",value); } 
}
...
{
get { if (ChanageProperty.ContainsKey("Level") == false) { return default(Int32); } else { return (Int32)ChanageProperty["Level"]; } } 
set { ChanageProperty.Add("Level",value); } 
}
